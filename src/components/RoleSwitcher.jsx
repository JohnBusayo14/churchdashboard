...
export default function RoleSwitcher() {
  const { actualRole, viewAsRole, effectiveRole, setViewAsRole } = useRole();
  ...
  const switched = !!viewAsRole && viewAsRole !== actualRole;
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        title="Switch which team's menus you're working with"
      >
        ...
        <div className="absolute right-0 z-30 mt-1 w-60 rounded-lg bg-white shadow-card ring-1 ring-zinc-200 py-1">
          ...
          {switched && (
            <>
              ...
              >
                Back to my team ({ROLE_LABELS[actualRole]})
              </button>
            </>
          )}
        </div>
